...
export const addList = () => {
    ...
    if (name == "" || age == "" || (!male.checked && !female.checked)){
        ...
        if(gender == "Nam") {
            document.getElementById("profile").insertAdjacentHTML('beforeend', `<custom-card index="${listProfile.length-1}" name="${name}" age="${age}" create="${created_at}" image="https://i0.wp.com/s1.uphinh.org/2021/05/31/default-profile-icon-26-2.jpg"></custom-card>`);
        }
        else {
